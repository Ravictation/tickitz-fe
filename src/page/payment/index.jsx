...
function Payment() {
  ...
  useEffect(() => {
    ...
    let count_seat = 0
    seats.split(",").map((v) => v != '' ? v != ' ' ? count_seat++ : "" : "")
    settotal(count_seat * price)
  })
    ...
    <>
      ...
      <main className="w-full bg-background flex flex-col items-center pb-10">
        ...
        <div className="bg-white w-3/4 px-10 py-10">
          ...
          <button className="w-full bg-blue-700 text-white py-5 mt-5 font-bold rounded" onClick={() => window.my_modal_2.showModal()}>Pay your order</button>
          <dialog id="my_modal_2" className="modal">
            <form method="dialog" className="modal-box">
              ...
              <div className="btn text-white w-full bg-blue-700 mt-5 rounded" onClick={purchase}>Check Payment</div>
